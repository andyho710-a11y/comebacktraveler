...
// 越南旅遊準備（首頁第一主軸）：行李、用品、防蚊、打包、女生旅行。
export const prepArticles = [
  {
    tag: '出國用品清單',
    title: '防盜斜背包怎麼選？越南自由行的前背、拉鍊與背帶檢查指南',
    desc: '防盜包不是有標籤就安全。用前背方式、拉鍊位置、背帶固定與容量，判斷現有包能不能沿用，也整理一款可進一步比價的斜背包。',
    href: '/anti-theft-crossbody-bag-guide',
    label: '看防盜斜背包指南 →',
    pubDate: '2026-07-31',
  },
  {
  ...
  {
    tag: '出國用品清單',
    title: '越南女生旅行用品清單｜防曬、防蚊、個人用品怎麼準備',
    desc: '越南女生旅行要帶什麼？住越南十年的在地人整理防曬、防蚊、個人清潔、安全防盜、美妝保養，哪些台灣先帶、哪些當地再買，一篇說清楚。',
...
// 提醒：eSIM 內容皆為依官方規格與使用情境整理，文案避免誇大個人使用經驗。
